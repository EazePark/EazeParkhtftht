...
<body>
    <div class="container">
        <div class="content">
            ...
            <img src="Eazepark.png" alt="Car Image">
        </div>
...
"""
# You can now use the `html_code` variable in your Python program as needed.
        ...
        for email_id in email_id_list:
            ...
            if car_number == car_number and money_paid == total_charge:
                # Delete the car number from the database after successful payment
                delete_car_number(car_number)
                # Open a thank you HTML page or perform other actions
                driver=webdriver.Chrome()
                driver.get('file:///C:/EazePark/Sign_Out/templates/thank_you.html')
                time.sleep(10)
                driver.quit()
            else:
                # Handle the case where the payment is not verified
                driver=webdriver.Chrome()
                driver.get('file:///C:/EazePark/Sign_Out/templates/NoNotfound.html')
                time.sleep(7)
                driver.quit()
